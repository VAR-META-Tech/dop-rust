...
export const MOCK_TOKEN_ADDRESS_2 = '0xe76C6c83af64e4C60245D8C7dE953DF673a7A33D';
...
export const MOCK_DOP_WALLET_ADDRESS = '0zk1q8hxknrs97q8pjxaagwthzc0df99rzmhl2xnlxmgv9akv32sua0kfrv7j6fe3z53llhxknrs97q8pjxaagwthzc0df99rzmhl2xnlxmgv9akv32sua0kg0zpzts';
const MOCK_TOKEN_AMOUNT_RECIPIENTS = MOCK_TOKEN_AMOUNTS.map(erc20Amount => ({
    ...erc20Amount,
    recipientAddress: MOCK_DOP_WALLET_ADDRESS,
}));
export const MOCK_MEMO = 'A nice little mock memo, and how bout a little more for ya? 🤩';
const encryptionKey = '0101010101010101010101010101010101010101010101010101010101010101';
export const MOCK_DB_ENCRYPTION_KEY = '0101010101010101010101010101010101010101010101010101010101010101';
export const MOCK_FEE_TOKEN_DETAILS = {
    tokenAddress: MOCK_TOKEN_ADDRESS,
    feePerUnitGas: BigInt('0x2000000000000000000'), // 2x
};
export const MOCK_TRANSACTION_GAS_DETAILS_SERIALIZED_TYPE_2 = {
...
(async () => {
    ...
    try {
        ...
        const dopWalletInfo = await createDopWallet(MOCK_DB_ENCRYPTION_KEY, MOCK_MNEMONIC, undefined);
